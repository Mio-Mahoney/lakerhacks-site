...
<div class="sticky top-0 bg-[#0b111f] z-50">
	...
	<!-- Navigation -->
	<nav
		class={`${isMenuOpen ? 'block fixed inset-0 top-[68px] bg-[#0b111f]' : 'hidden'} border-b border-gray-800  px-[20px] py-[14px] xl:static xl:block`}
	>
